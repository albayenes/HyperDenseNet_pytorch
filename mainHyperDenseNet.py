...
def runTraining(opts):
    ...
    train_loader = torch.utils.data.DataLoader(train_set, batch_size=1, num_workers=2, shuffle=True)
    ...
    valid_loader = torch.utils.data.DataLoader(valid_set, batch_size=1, num_workers=2, shuffle=True)
